...
if("FALSE" STREQUAL "TRUE")
  set(face_recognition_SOURCE_PREFIX /home/asaad/idris/src/idris_home_league/procrob_functional)
...
if(NOT "include" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'face_recognition' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/asaad/idris/install/${idir}'.  Ask the maintainer 'Pouyan Ziafati (Author) <pouyan.ziafati@uni.lu>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/asaad/idris/install/lib;/home/asaad/idris/devel/lib;/home/asaad/turtlebot_arm/devel/lib;/home/asaad/catkin_ws/devel/lib;/opt/ros/hydro/lib)
